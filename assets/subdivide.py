...
def subdivide_assembly(source_dir, target_dir, max_edge):
    # load objs
    assembly = load_assembly(source_dir, transform='none')
    ...
    if os.path.exists(source_cfg_path):
        shutil.copyfile(source_cfg_path, target_cfg_path)
...
if __name__ == '__main__':
    ...
    subdivide_assembly(args.source_dir, args.target_dir, args.max_edge)
