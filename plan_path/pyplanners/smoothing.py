...
def smooth_path(path, extend_fn, collision_fn, distance_fn=None, cost_fn=None, sample_fn=None,
                max_iterations=50, max_time=INF, converge_time=INF, tolerance=1e-3, verbose=False):
    """
    ...
    waypoints = waypoints_from_path(path, difference_fn=None, tolerance=tolerance) # TODO: difference_fn
