...
BodyAbstract::BodyAbstract(Simulation* sim, Joint* joint, 
    ...
    _mass = mass;
    _scale = scale;
    _visual_frame = SE3::Identity();
    _visual_frame.block<3, 3>(0, 0) = visual_frame_R;
    _visual_frame.block<3, 1>(0, 3) = visual_frame_pos;
    _collision_frame = SE3::Identity();
    _collision_frame.block<3, 3>(0, 0) = collision_frame_R;
    _collision_frame.block<3, 1>(0, 3) = collision_frame_pos;
