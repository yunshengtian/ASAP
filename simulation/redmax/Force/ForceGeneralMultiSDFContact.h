...
class ForceGeneralMultiSDFContact : public Force {
public:
    Body* _contact_body; // the general contact body should be able to give a list of contact points on the surface.
    BodyMultiSDFObj* _SDF_body; // the MultiSDF body is supposed to have a distance field
