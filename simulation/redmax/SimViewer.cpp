...
void SimViewerKeyboardHandler::KeyCallback(const int key, const int action) {
    if (key == GLFW_KEY_SPACE && action == GLFW_PRESS) {
        ...
        std::cerr << "camera pos = " << viewer.GetPosition().transpose() << std::endl;
        std::cerr << "camera look at = " << viewer.GetLookAt().transpose() << std::endl;
    }
}
...
void SimViewer::initialize() {
    ...
    // const Eigen::Vector3f light_position(0.f, 0.f, 15);
    ...
    if (_sim->_viewer_options->_camera_up[1] > 0.5) {
        ...
        light_option.SetVectorOption("ambient", 0.27f, 0.25f, 0.24f);
        // light_option.SetVectorOption("diffuse", 0.37f, 0.35f, 0.34f);
        light_option.SetVectorOption("diffuse", 0.8f, 0.8f, 0.8f);
        // light_option.SetVectorOption("specular", 0.37f, 0.35f, 0.34f);
        light_option.SetVectorOption("specular", 0.0f, 0.0f, 0.0f);
