...
PYBIND11_MODULE(redmax_py, m) {
    ...
    py::class_<Simulation>(m, "Simulation")
        ...
        .def("set_q_init", &Simulation::set_q_init, 
                ...
                py::arg("q_init"))
        .def("set_joint_q_init", &Simulation::set_joint_q_init, 
                "set init q for simulation",
                py::arg("joint_name"), py::arg("q_init"))
        .def("set_qdot_init", &Simulation::set_qdot_init, 
                "set init qdot for simulation",
                py::arg("qdot_init"))
        .def("set_joint_qdot_init", &Simulation::set_joint_qdot_init, 
                "set init qdot for simulation",
                py::arg("joint_name"), py::arg("qdot_init"))
        ...
        .def("get_qdot", &Simulation::get_qdot,
                "get qdot")
        .def("get_q_map", &Simulation::get_q_map,
                "get q_map")
        .def("get_qdot_map", &Simulation::get_qdot_map,
                "get qdot_map")
        ...
        .def("set_qdot", &Simulation::set_qdot,
                "set qdot",
                py::arg("qdot"))
        .def("set_q_map", &Simulation::set_q_map,
                "set q_map",
                py::arg("q_map"))
        .def("set_qdot_map", &Simulation::set_qdot_map,
                "set qdot_map",
                py::arg("qdot_map"))
        ...
        .def("get_joint_qmdot", &Simulation::get_joint_qmdot,
                ...
                py::arg("name"))
        .def("get_joint_q_from_qm", &Simulation::get_joint_q_from_qm,
                "get q of the joint from qm",
        ...
        .def("zero_joint_qdot", &Simulation::zero_joint_qdot,
                ...
                py::arg("name"))
        .def("get_joint_Ej0_init", &Simulation::get_joint_Ej0_init,
                "get initial Ej0 of the joint",
                py::arg("name"))
        ...
        .def("get_body_Ei0", &Simulation::get_body_Ei0,
                "get Ei0 of the body",
                py::arg("name"))
        .def("get_body_E0j", &Simulation::get_body_E0j,
                "get E0j of the body",
                py::arg("name"))
        .def("get_body_E0j_map", &Simulation::get_body_E0j_map,
                "get E0j of the body")
        ...
        .def("get_body_distance", &Simulation::get_body_distance,
                ...
                py::arg("name_from"), py::arg("name_to"))
        .def("get_body_distance_group", &Simulation::get_body_distance_group,
                "get distance from group of bodies A to group of bodies B",
                py::arg("names_from"), py::arg("names_to"))
        ...
        .def("set_body_color_map", &Simulation::set_body_color_map,
                "set color for bodies",
                py::arg("color_map"))

        // .def("get_Fm", &Simulation::get_Fm,
        //         "Get force in maximal coordinates")
        .def("get_acc", &Simulation::get_acc,
                "Get acceleration in maximal coordinates")
        ...
        .def("inverse_dynamics_balance", &Simulation::inverse_dynamics_balance,
                "compute inverse dynamics to balance")
        .def("inverse_dynamics_balance_map", &Simulation::inverse_dynamics_balance_map,
                "compute inverse dynamics map to balance")
        ...
        .def("export_replay", &Simulation::export_replay,
                ...
                py::arg("folder"))
        .def("export_replay_matrices", &Simulation::export_replay_matrices,
                "export the body transformations in each step.")
